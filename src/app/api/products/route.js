...
// // ✅ POST: Create a new product (JWT required)
// export const POST = async (req) => {
...
//   const body = await req.json();
//   const productsCollections = await dbConnect(collectionNamesObj.productsCollection);
//   const result = await productsCollections.insertOne(body);

//   return NextResponse.json(result);
// };

// // ✅ GET: Get all products (JWT required)
